      ...
      <section className="bg-deep text-white">
        <div className="mx-auto max-w-6xl px-4 py-16 md:px-6">
          <h2 className="max-w-3xl font-serif text-3xl md:text-5xl">
            Ready to work with a nutritionist in Astoria, Queens, or NYC?
          </h2>
          <p className="mt-4 max-w-2xl text-white/75">
            Together we’ll look beyond symptoms and build a realistic, evidence-based plan —
            remote Medical Nutrition Therapy across New York City, with in-person Reiki and
            sound baths in Astoria.
          </p>
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <article className="rounded-3xl bg-white/6 p-6 ring-1 ring-white/10">
              ...
              <p className="mt-2 text-sm text-white/70">
                A complimentary 20-minute call for clients in Astoria, Queens, and across NYC
                to share what you’re looking for and see if working together is the right fit.
              </p>
